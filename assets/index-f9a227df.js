...
`)},m=0;m<a;m++)c(m);return s}(o)})}return e.registerId=function(t){return Ro(t)},e.prototype.reconstructWithOptions=function(t,n){return n===void 0&&(n=!0),new e(Ee(Ee({},this.options),t),this.gs,n&&this.names||void 0)},e.prototype.allocateGSInstance=function(t){return this.gs[t]=(this.gs[t]||0)+1},e.prototype.getTag=function(){return this.tag||(this.tag=(t=function(n){var r=n.useCSSOMInjection,o=n.target;return n.isServer?new zh(o):r?new Ph(o):new Nh(o)}(this.options),new Sh(t)));var t},e.prototype.hasNameForId=function(t,n){return this.names.has(t)&&this.names.get(t).has(n)},e.prototype.registerName=function(t,n){if(Ro(t),this.names.has(t))this.names.get(t).add(n);else{var r=new Set;r.add(n),this.names.set(t,r)}},e.prototype.insertRules=function(t,n,r){this.registerName(t,n),this.getTag().insertRules(Ro(t),r)},e.prototype.clearNames=function(t){this.names.has(t)&&this.names.get(t).clear()},e.prototype.clearRules=function(t){this.getTag().clearGroup(Ro(t)),this.clearNames(t)},e.prototype.clearTag=function(){this.tag=void 0},e}(),Rh=/&/g,Oh=/^\s*\/\/.*$/gm;function Rp(e,t){return e.map(function(n){return n.type==="rule"&&(n.value="".concat(t," ").concat(n.value),n.value=n.value.replaceAll(",",",".concat(t," ")),n.props=n.props.map(function(r){return"".concat(t," ").concat(r)})),Array.isArray(n.children)&&n.type!=="@keyframes"&&(n.children=Rp(n.children,t)),n})}function Ih(e){var t,n,r,o=e===void 0?nr:e,i=o.options,l=i===void 0?nr:i,a=o.plugins,s=a===void 0?Ki:a,c=function(h,g,w){return w===n||w.startsWith(n)&&w.endsWith(n)&&w.replaceAll(n,"").length>0?".".concat(t):h},m=s.slice();m.push(function(h){h.type===Wi&&h.value.includes("&")&&(h.props[0]=h.props[0].replace(Rh,n).replace(r,c))}),l.prefix&&m.push(ih),m.push(nh);var p=function(h,g,w,y){g===void 0&&(g=""),w===void 0&&(w=""),y===void 0&&(y="&"),t=y,n=g,r=new RegExp("\\".concat(n,"\\b"),"g");var N=h.replace(Oh,""),f=eh(w||g?"".concat(w," ").concat(g," { ").concat(N," }"):N);l.namespace&&(f=Rp(f,l.namespace));var u=[];return Ci(f,rh(m.concat(oh(function(d){return u.push(d)})))),u};return p.hash=s.length?s.reduce(function(h,g){return g.name||uo(15),Dn(h,g.name)},5381).toString():"",p}var jh=new _i,qa=Ih(),Op=ce.createContext({shouldForwardProp:void 0,styleSheet:jh,stylis:qa});Op.Consumer;ce.createContext(void 0);function ba(){return L.useContext(Op)}var Lh=function(){function e(t,n){var r=this;this.inject=function(o,i){i===void 0&&(i=qa);var l=r.name+i.hash;o.hasNameForId(r.id,l)||o.insertRules(r.id,l,i(r.rules,l,"@keyframes"))},this.name=t,this.id="sc-keyframes-".concat(t),this.rules=n,ou(this,function(){throw uo(12,String(r.name))})}return e.prototype.getName=function(t){return t===void 0&&(t=qa),this.name+t.hash},e}(),Mh=function(e){return e>="A"&&e<="Z"};function Ac(e){for(var t="",n=0;n<e.length;n++){var r=e[n];if(n===1&&r==="-"&&e[0]==="-")return e;Mh(r)?t+="-"+r.toLowerCase():t+=r}return t.startsWith("ms-")?"-"+t:t}var Ip=function(e){return e==null||e===!1||e===""},jp=function(e){var t,n,r=[];for(var o in e){var i=e[o];e.hasOwnProperty(o)&&!Ip(i)&&(Array.isArray(i)&&i.isCss||rr(i)?r.push("".concat(Ac(o),":"),i,";"):br(i)?r.push.apply(r,qr(qr(["".concat(o," {")],jp(i),!1),["}"],!1)):r.push("".concat(Ac(o),": ").concat((t=o,(n=i)==null||typeof n=="boolean"||n===""?"":typeof n!="number"||n===0||t in xp||t.startsWith("--")?String(n).trim():"".concat(n,"px")),";")))}return r};function Jt(e,t,n,r){if(Ip(e))return[];if(ru(e))return[".".concat(e.styledComponentId)];if(rr(e)){if(!rr(i=e)||i.prototype&&i.prototype.isReactComponent||!t)return[e];var o=e(t);return Jt(o,t,n,r)}var i;return e instanceof Lh?n?(e.inject(n,r),[e.getName(r)]):[e]:br(e)?jp(e):Array.isArray(e)?Array.prototype.concat.apply(Ki,e.map(function(l){return Jt(l,t,n,r)})):[e.toString()]}function Lp(e){for(var t=0;t<e.length;t+=1){var n=e[t];if(rr(n)&&!ru(n))return!1}return!0}var Ah=Cp("6.0.5"),Dh=function(){function e(t,n,r){this.rules=t,this.staticRulesId="",this.isStatic=(r===void 0||r.isStatic)&&Lp(t),this.componentId=n,this.baseHash=Dn(Ah,n),this.baseStyle=r,_i.registerId(n)}return e.prototype.generateAndInjectStyles=function(t,n,r){var o=this.baseStyle?this.baseStyle.generateAndInjectStyles(t,n,r):"";if(this.isStatic&&!r.hash)if(this.staticRulesId&&n.hasNameForId(this.componentId,this.staticRulesId))o=pn(o,this.staticRulesId);else{var i=Za(Jt(this.rules,t,n,r)),l=Ga(Dn(this.baseHash,i)>>>0);if(!n.hasNameForId(this.componentId,l)){var a=r(i,".".concat(l),void 0,this.componentId);n.insertRules(this.componentId,l,a)}o=pn(o,l),this.staticRulesId=l}else{for(var s=Dn(this.baseHash,r.hash),c="",m=0;m<this.rules.length;m++){var p=this.rules[m];if(typeof p=="string")c+=p;else if(p){var h=Za(Jt(p,t,n,r));s=Dn(s,h),c+=h}}if(c){var g=Ga(s>>>0);n.hasNameForId(this.componentId,g)||n.insertRules(this.componentId,g,r(c,".".concat(g),void 0,this.componentId)),o=pn(o,g)}}return o},e}(),iu=ce.createContext(void 0);iu.Consumer;var Zl={};function Fh(e,t,n){var r=ru(e),o=e,i=!Kl(e),l=t.attrs,a=l===void 0?Ki:l,s=t.componentId,c=s===void 0?function(d,v){var x=typeof d!="string"?"sc":Rc(d);Zl[x]=(Zl[x]||0)+1;var E="".concat(x,"-").concat($p("6.0.5"+x+Zl[x]));return v?"".concat(v,"-").concat(E):E}(t.displayName,t.parentComponentId):s,m=t.displayName;m===void 0&&function(d){return Kl(d)?"styled.".concat(d):"Styled(".concat(fh(d),")")}(e);var p=t.displayName&&t.componentId?"".concat(Rc(t.displayName),"-").concat(t.componentId):t.componentId||c,h=r&&o.attrs?o.attrs.concat(a).filter(Boolean):a,g=t.shouldForwardProp;if(r&&o.shouldForwardProp){var w=o.shouldForwardProp;if(t.shouldForwardProp){var y=t.shouldForwardProp;g=function(d,v){return w(d,v)&&y(d,v)}}else g=w}var N=new Dh(n,p,r?o.componentStyle:void 0);function f(d,v){return function(x,E,S){var z=x.attrs,G=x.componentStyle,I=x.defaultProps,Le=x.foldedComponentIds,on=x.styledComponentId,ln=x.target,fo=ce.useContext(iu),vl=ba(),an=x.shouldForwardProp||vl.shouldForwardProp,Qe=function(St,Me,Ot){for(var Ae,Xe=Ee(Ee({},Me),{className:void 0,theme:Ot}),wl=0;wl<St.length;wl+=1){var po=rr(Ae=St[wl])?Ae(Xe):Ae;for(var It in po)Xe[It]=It==="className"?pn(Xe[It],po[It]):It==="style"?Ee(Ee({},Xe[It]),po[It]):po[It]}return Me.className&&(Xe.className=pn(Xe.className,Me.className)),Xe}(z,E,kp(E,fo,I)||nr),_=Qe.as||ln,T={};for(var R in Qe)Qe[R]===void 0||R[0]==="$"||R==="as"||R==="theme"||(R==="forwardedAs"?T.as=Qe.forwardedAs:an&&!an(R,_)||(T[R]=Qe[R]));var X=function(St,Me){var Ot=ba(),Ae=St.generateAndInjectStyles(Me,Ot.styleSheet,Ot.stylis);return Ae}(G,Qe),b=pn(Le,on);return X&&(b+=" "+X),Qe.className&&(b+=" "+Qe.className),T[Kl(_)&&!Ep.has(_)?"class":"className"]=b,T.ref=S,L.createElement(_,T)}(u,d,v)}var u=ce.forwardRef(f);return u.attrs=h,u.componentStyle=N,u.shouldForwardProp=g,u.foldedComponentIds=r?pn(o.foldedComponentIds,o.styledComponentId):"",u.styledComponentId=p,u.target=r?o.target:e,Object.defineProperty(u,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(d){this._foldedDefaultProps=r?function(v){for(var x=[],E=1;E<arguments.length;E++)x[E-1]=arguments[E];for(var S=0,z=x;S<z.length;S++)Ja(v,z[S],!0);return v}({},o.defaultProps,d):d}}),ou(u,function(){return".".concat(u.styledComponentId)}),i&&zp(u,e,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),u}function Dc(e,t){for(var n=[e[0]],r=0,o=t.length;r<o;r+=1)n.push(t[r],e[r+1]);return n}var Fc=function(e){return Object.assign(e,{isCss:!0})};function Mp(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];if(rr(e)||br(e)){var r=e;return Fc(Jt(Dc(Ki,qr([r],t,!0))))}var o=e;return t.length===0&&o.length===1&&typeof o[0]=="string"?Jt(o):Fc(Jt(Dc(o,t)))}function es(e,t,n){if(n===void 0&&(n=nr),!t)throw uo(1,t);var r=function(o){for(var i=[],l=1;l<arguments.length;l++)i[l-1]=arguments[l];return e(t,n,Mp.apply(void 0,qr([o],i,!1)))};return r.attrs=function(o){return es(e,t,Ee(Ee({},n),{attrs:Array.prototype.concat(n.attrs,o).filter(Boolean)}))},r.withConfig=function(o){return es(e,t,Ee(Ee({},n),o))},r}var Ap=function(e){return es(Fh,e)},ve=Ap;Ep.forEach(function(e){ve[e]=Ap(e)});var Uh=function(){function e(t,n){this.rules=t,this.componentId=n,this.isStatic=Lp(t),_i.registerId(this.componentId+1)}return e.prototype.createStyles=function(t,n,r,o){var i=o(Za(Jt(this.rules,n,r,o)),""),l=this.componentId+t;r.insertRules(l,l,i)},e.prototype.removeStyles=function(t,n){n.clearRules(this.componentId+t)},e.prototype.renderStyles=function(t,n,r,o){t>2&&_i.registerId(this.componentId+t),this.removeStyles(t,r),this.createStyles(t,n,r,o)},e}();function Bh(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];var r=Mp.apply(void 0,qr([e],t,!1)),o="sc-global-".concat($p(JSON.stringify(r))),i=new Uh(r,o),l=function(s){var c=ba(),m=ce.useContext(iu),p=ce.useRef(c.styleSheet.allocateGSInstance(o)).current;return c.styleSheet.server&&a(p,s,c.styleSheet,m,c.stylis),ce.useLayoutEffect(function(){if(!c.styleSheet.server)return a(p,s,c.styleSheet,m,c.stylis),function(){return i.removeStyles(p,c.styleSheet)}},[p,s,c.styleSheet,m,c.stylis]),null};function a(s,c,m,p,h){if(i.isStatic)i.renderStyles(s,ah,m,h);else{var g=Ee(Ee({},c),{theme:kp(c,p,l.defaultProps)});i.renderStyles(s,g,m,h)}}return ce.memo(l)}const Lt=ve.p`
  word-spacing: 5px;
  line-height: 1.2;
  
`;function Vh(){return $.jsxs($.Fragment,{children:[$.jsx(Lt,{children:"Olá! Sou um entusiasta apaixonado por desenvolvimento web, focado principalmente no universo frontend. Meu nome é Rafael, e estou sempre buscando aprender e aprimorar minhas habilidades para criar experiências de usuário incríveis."}),$.jsx(Lt,{children:"Iniciei minha paixão por codificação em 2012, quando entrei na faculdade Eniac para cursar Sistemas de Informação."}),$.jsx(Lt,{children:"Todo trabalho que envolvia programação, era direcionado à mim. Meus primeiros passos com HTML começaram aqui, e desde então nunca parei."}),$.jsx(Lt,{children:"Em 2018 começei a investir de fato na minha carreira como programador."}),$.jsxs(Lt,{children:["Comecei meus estudos com ",$.jsx("b",{children:"Csharp"})," e ",$.jsx("b",{children:"Unity"})," para criar"," ",$.jsx("a",{href:"https://rafones12.itch.io/",target:"_blank",children:"Jogos"}),", e também criei muitos sites para pessoas proximas utilizando WordPress."]}),$.jsx(Lt,{children:"Tenho experiência prática profissional de 2 anos no desenvolvimento front, interfaces de usuário responsivas e interativas, utilizando bibliotecas e frameworks modernos como React e Angular. Também estou familiarizado com o uso de preprocessadores CSS, controle de versão com Git e integração com APIs."}),$.jsx(Lt,{children:"Além do código, sou um defensor da usabilidade e da acessibilidade, acreditando que a experiência do usuário é fundamental para o sucesso de qualquer projeto. Adoro trabalhar em equipes colaborativas, onde posso contribuir com minhas ideias e aprender com os outros."}),$.jsxs(Lt,{children:["Hoje estou me especializando fortemente em ",$.jsx("b",{children:"React"}),", Javascript e suas principais funções."]})]})}const Hh=ve.main`
  display: flex;
  flex-direction: row;
  gap: 1rem;
