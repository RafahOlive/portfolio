...
`;function ey(){return $.jsx($.Fragment,{children:$.jsxs(Jh,{children:[$.jsx(qh,{children:"2022 - 2023"}),$.jsxs(bh,{children:[$.jsx("h3",{children:"Pacto Soluções"}),$.jsx("h4",{children:"Desenvolvedor frontend"}),$.jsx("p",{children:"Migração do sistema em JSX para Angular"})]})]})})}const Hc="/portfolio/assets/todo-fd76723f.png",ty=ve.div`
  ...
  color: #5ee9d3;
`;function ft(e){return $.jsx(ty,{children:e.name})}const Oo={extraSmall:"600px",small:"600px",medium:"768px",large:"1024px"},fe={extraSmall:`only screen and (max-width: ${Oo.extraSmall})`,small:`only screen and (min-width: ${Oo.small})`,medium:`only screen and (min-width: ${Oo.medium})`,large:`only screen and (min-width: ${Oo.large})`},ny=ve.div`
display: flex;
