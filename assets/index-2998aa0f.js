 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var T0=L,R0=Symbol.for("react.element"),O0=Symbol.for("react.fragment"),j0=Object.prototype.hasOwnProperty,I0=T0.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,L0={key:!0,ref:!0,__self:!0,__source:!0};function ff(e,t,n){var r,o={},i=null,l=null;n!==void 0&&(i=""+n),t.key!==void 0&&(i=""+t.key),t.ref!==void 0&&(l=t.ref);for(r in t)j0.call(t,r)&&!L0.hasOwnProperty(r)&&(o[r]=t[r]);if(e&&e.defaultProps)for(r in t=e.defaultProps,t)o[r]===void 0&&(o[r]=t[r]);return{$$typeof:R0,type:e,key:i,ref:l,props:o,_owner:I0.current}}Ni.Fragment=O0;Ni.jsx=ff;Ni.jsxs=ff;tf.exports=Ni;var k=tf.exports,ia={},df={exports:{}},We={},pf={exports:{}},mf={};/**
 * @license React
...
`;function Qh(){return k.jsx(k.Fragment,{children:k.jsxs(Hh,{children:[k.jsx(Wh,{children:"2022 - 2023"}),k.jsxs(Yh,{children:[k.jsx("h3",{children:"Pacto Soluções"}),k.jsx("h4",{children:"Desenvolvedor frontend"}),k.jsx("p",{children:"Migração do sistema em JSX para Angular"})]})]})})}const Jl="/portfolio/assets/todo-fd76723f.png",Xh=ve.div`
  width: auto;
  height: 28px;
  ...
  color: #5ee9d3;
`;function $e(e){return k.jsx(Xh,{children:e.name})}const vr={extraSmall:"600px",small:"600px",medium:"768px",large:"1024px",extraLarge:"1200px"},fe={extraSmall:`only screen and (max-width: ${vr.extraSmall})`,small:`only screen and (min-width: ${vr.small})`,medium:`only screen and (min-width: ${vr.medium})`,large:`only screen and (min-width: ${vr.large})`,extraLarge:`only screen and (min-width: ${vr.extraLarge})`},Kh=ve.div`
display: flex;
...
`;function Ig(e,t,n){switch(n){case"bottom-left":return t?kg:ig;case"bottom-right":return t?Eg:lg;case"down":return e?t?$g:sg:t?Cg:ag;case"left":return e?t?Pg:ug:t?_g:Eu;case"right":return e?t?zg:fg:t?Ng:cg;case"top-left":return t?Tg:dg;case"top-right":return t?Rg:pg;case"up":return e?t?jg:hg:t?Og:mg;default:return t?xg:og}}const Lg=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=L.useMemo(()=>Ig(t,r,n),[t,n,r]);return ae(s0,{keyframes:i,...o})};$`
  from {
...
`;function Yg(){const[e,t]=L.useState(!1),[n,r]=L.useState(!1),[o,i]=L.useState(!1);function l(){t(!0),r(!1),i(!1)}function a(){t(!1),r(!0),i(!1)}function s(){t(!1),r(!1),i(!0)}return k.jsxs(Ug,{children:[k.jsxs(Bg,{children:[k.jsx("h1",{children:"Rafael Ribeiro"}),k.jsx("h3",{children:"Desenvolvedor Frontend e Engenheiro de Software"}),k.jsx("p",{children:"Crio sites responsivos, soluções web e alguns jogos 🎮"}),k.jsxs(Vg,{children:[k.jsx("button",{onClick:l,children:"Sobre"}),k.jsx("button",{onClick:a,children:"Experiência"}),k.jsx("button",{onClick:s,children:"Projetos"})]}),k.jsxs(Hg,{children:[k.jsx("a",{href:"https://www.linkedin.com/in/rafaelribeirodev/",target:"_blank",children:k.jsx(Fg,{size:24})}),k.jsx("a",{href:"https://github.com/RafahOlive",target:"_blank",children:k.jsx(Dg,{size:24})})]})]}),k.jsx(Wg,{children:k.jsxs(Lg,{duration:1e3,children:[e&&k.jsx(Vh,{}),n&&k.jsx(Qh,{}),o&&k.jsx(Gh,{})]})})]})}const Qg=Bh`
*{
  margin: 0;
  padding: 0;
...
`;function Xg(){return k.jsxs(k.Fragment,{children:[k.jsx(Qg,{}),k.jsx(Yg,{})]})}ia.createRoot(document.getElementById("root")).render(k.jsx(ce.StrictMode,{children:k.jsx(Xg,{})}));
