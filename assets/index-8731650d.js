 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t($,T){var R=$.length;$.push(T);e:for(;0<R;){var X=R-1>>>1,ee=$[X];if(0<o(ee,T))$[X]=T,$[R]=ee,R=X;else break e}}function n($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var T=$[0],R=$.pop();if(R!==T){$[0]=R;e:for(var X=0,ee=$.length,vt=ee>>>1;X<vt;){var Me=2*(X+1)-1,Ot=$[Me],Le=Me+1,Qe=$[Le];if(0>o(Ot,R))Le<ee&&0>o(Qe,Ot)?($[X]=Qe,$[Le]=R,X=Le):($[X]=Ot,$[Me]=R,X=Me);else if(Le<ee&&0>o(Qe,R))$[X]=Qe,$[Le]=R,X=Le;else break e}}return T}function o($,T){var R=$.sortIndex-T.sortIndex;return R!==0?R:$.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],c=[],m=1,p=null,h=3,g=!1,v=!1,y=!1,N=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d($){for(var T=n(c);T!==null;){if(T.callback===null)r(c);else if(T.startTime<=$)r(c),T.sortIndex=T.expirationTime,t(s,T);else break;T=n(c)}}function w($){if(y=!1,d($),!v)if(n(s)!==null)v=!0,nn(x);else{var T=n(c);T!==null&&Ye(w,T.startTime-$)}}function x($,T){v=!1,y&&(y=!1,f(z),z=-1),g=!0;var R=h;try{for(d(T),p=n(s);p!==null&&(!(p.expirationTime>T)||$&&!Ie());){var X=p.callback;if(typeof X=="function"){p.callback=null,h=p.priorityLevel;var ee=X(p.expirationTime<=T);T=e.unstable_now(),typeof ee=="function"?p.callback=ee:p===n(s)&&r(s),d(T)}else r(s);p=n(s)}if(p!==null)var vt=!0;else{var Me=n(c);Me!==null&&Ye(w,Me.startTime-T),vt=!1}return vt}finally{p=null,h=R,g=!1}}var E=!1,S=null,z=-1,G=5,M=-1;function Ie(){return!(e.unstable_now()-M<G)}function en(){if(S!==null){var $=e.unstable_now();M=$;var T=!0;try{T=S(!0,$)}finally{T?tn():(E=!1,S=null)}}else E=!1}var tn;if(typeof u=="function")tn=function(){u(en)};else if(typeof MessageChannel<"u"){var uo=new MessageChannel,gl=uo.port2;uo.port1.onmessage=en,tn=function(){gl.postMessage(null)}}else tn=function(){N(en,0)};function nn($){S=$,E||(E=!0,tn())}function Ye($,T){z=N(function(){$(e.unstable_now())},T)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function($){$.callback=null},e.unstable_continueExecution=function(){v||g||(v=!0,nn(x))},e.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):G=0<$?Math.floor(1e3/$):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function($){switch(h){case 1:case 2:case 3:var T=3;break;default:T=h}var R=h;h=T;try{return $()}finally{h=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function($,T){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var R=h;h=$;try{return T()}finally{h=R}},e.unstable_scheduleCallback=function($,T,R){var X=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?X+R:X):R=X,$){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=R+ee,$={id:m++,callback:T,priorityLevel:$,startTime:R,expirationTime:ee,sortIndex:-1},R>X?($.sortIndex=R,t(c,$),n(s)===null&&$===n(c)&&(y?(f(z),z=-1):y=!0,Ye(w,R-X))):($.sortIndex=ee,t(s,$),v||g||(v=!0,nn(x))),$},e.unstable_shouldYield=Ie,e.unstable_wrapCallback=function($){var T=h;return function(){var R=h;h=T;try{return $.apply(this,arguments)}finally{h=R}}}})(hf);mf.exports=hf;var Fp=mf.exports;/**
 * @license React
...
`;function Xh(){return _.jsx(_.Fragment,{children:_.jsxs(Yh,{children:[_.jsx(Qh,{children:"2022 - 2023"}),_.jsxs(Zh,{children:[_.jsx("h3",{children:"Pacto Soluções"}),_.jsx("h4",{children:"Desenvolvedor frontend"}),_.jsx("p",{children:"Migração do sistema em JSX para Angular"})]})]})})}const Kh=Ee.div`
  width: auto;
  height: 28px;
  ...
  color: #5ee9d3;
`;function Gl(e){return _.jsx(Kh,{children:e.name})}const rn={mobileS:"320px",mobileM:"375px",mobileL:"641px",tablet:"768px",laptop:"1024px",laptopL:"1440px",desktop:"2560px"},xn={mobileS:`(min-width: ${rn.mobileS})`,mobileM:`(min-width: ${rn.mobileM})`,mobileL:`screen and (max-width: ${rn.mobileL})`,tablet:`(min-width: ${rn.tablet})`,laptop:`(min-width: ${rn.laptop})`,laptopL:`(min-width: ${rn.laptopL})`,desktop:`(min-width: ${rn.desktop})`},Gh=Ee.div`
  width: 576px;
  height: auto;
...
`,ey=Ee.div`
  ...
  flex-direction: row;
  gap: 10px;
`;function ty(e){return _.jsxs(Gh,{children:[_.jsx(Jh,{children:_.jsx("img",{src:e.img,sizes:"16px",alt:""})}),_.jsxs(qh,{children:[_.jsx("h3",{children:e.title}),_.jsx("p",{children:e.description}),_.jsxs(bh,{children:[_.jsx("a",{href:e.link,target:"_blank",children:"Projeto"}),_.jsx("a",{href:e.github,target:"_blank",children:"Repositorio"})]}),_.jsxs(ey,{children:[_.jsx(Gl,{name:"React"}),_.jsx(Gl,{name:"Vite"}),_.jsx(Gl,{name:"Styled-components"})]})]})]})}const ny="/portfolio/assets/todo-fd76723f.png";function ry(){return _.jsx(ty,{title:"Lista de tarefas",description:"Aplicativo que armazena suas tarefas diárias",link:"https://rafaholive.github.io/todo-list-react/",github:"https://github.com/RafahOlive/todo-list-react",img:ny})}function oy(e){if(e.sheet)return e.sheet;for(var t=0;t<document.styleSheets.length;t++)if(document.styleSheets[t].ownerNode===e)return document.styleSheets[t]}function iy(e){var t=document.createElement("style");return t.setAttribute("data-emotion",e.key),e.nonce!==void 0&&t.setAttribute("nonce",e.nonce),t.appendChild(document.createTextNode("")),t.setAttribute("data-s",""),t}var ly=function(){function e(n){var r=this;this._insertTag=function(o){var i;r.tags.length===0?r.insertionPoint?i=r.insertionPoint.nextSibling:r.prepend?i=r.container.firstChild:i=r.before:i=r.tags[r.tags.length-1].nextSibling,r.container.insertBefore(o,i),r.tags.push(o)},this.isSpeedy=n.speedy===void 0?!0:n.speedy,this.tags=[],this.ctr=0,this.nonce=n.nonce,this.key=n.key,this.container=n.container,this.prepend=n.prepend,this.insertionPoint=n.insertionPoint,this.before=null}var t=e.prototype;return t.hydrate=function(r){r.forEach(this._insertTag)},t.insert=function(r){this.ctr%(this.isSpeedy?65e3:1)===0&&this._insertTag(iy(this));var o=this.tags[this.tags.length-1];if(this.isSpeedy){var i=oy(o);try{i.insertRule(r,i.cssRules.length)}catch{}}else o.appendChild(document.createTextNode(r));this.ctr++},t.flush=function(){this.tags.forEach(function(r){return r.parentNode&&r.parentNode.removeChild(r)}),this.tags=[],this.ctr=0},e}(),we="-ms-",$i="-moz-",F="-webkit-",Dd="comm",lu="rule",au="decl",ay="@import",Vd="@keyframes",sy="@layer",uy=Math.abs,Xi=String.fromCharCode,cy=Object.assign;function fy(e,t){return me(e,0)^45?(((t<<2^me(e,0))<<2^me(e,1))<<2^me(e,2))<<2^me(e,3):0}function Hd(e){return e.trim()}function dy(e,t){return(e=t.exec(e))?e[0]:e}function D(e,t,n){return e.replace(t,n)}function ts(e,t){return e.indexOf(t)}function me(e,t){return e.charCodeAt(t)|0}function qr(e,t,n){return e.slice(t,n)}function dt(e){return e.length}function su(e){return e.length}function Oo(e,t){return t.push(e),e}function py(e,t){return e.map(t).join("")}var Ki=1,rr=1,Ud=0,Ae=0,oe=0,sr="";function Gi(e,t,n,r,o,i,l){return{value:e,root:t,parent:n,type:r,props:o,children:i,line:Ki,column:rr,length:l,return:""}}function gr(e,t){return cy(Gi("",null,null,"",null,null,0),e,{length:-e.length},t)}function my(){return oe}function hy(){return oe=Ae>0?me(sr,--Ae):0,rr--,oe===10&&(rr=1,Ki--),oe}function Ve(){return oe=Ae<Ud?me(sr,Ae++):0,rr++,oe===10&&(rr=1,Ki++),oe}function gt(){return me(sr,Ae)}function Ko(){return Ae}function so(e,t){return qr(sr,e,t)}function br(e){switch(e){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function Bd(e){return Ki=rr=1,Ud=dt(sr=e),Ae=0,[]}function Wd(e){return sr="",e}function Go(e){return Hd(so(Ae-1,ns(e===91?e+2:e===40?e+1:e)))}function yy(e){for(;(oe=gt())&&oe<33;)Ve();return br(e)>2||br(oe)>3?"":" "}function gy(e,t){for(;--t&&Ve()&&!(oe<48||oe>102||oe>57&&oe<65||oe>70&&oe<97););return so(e,Ko()+(t<6&&gt()==32&&Ve()==32))}function ns(e){for(;Ve();)switch(oe){case e:return Ae;case 34:case 39:e!==34&&e!==39&&ns(oe);break;case 40:e===41&&ns(e);break;case 92:Ve();break}return Ae}function vy(e,t){for(;Ve()&&e+oe!==47+10;)if(e+oe===42+42&&gt()===47)break;return"/*"+so(t,Ae-1)+"*"+Xi(e===47?e:Ve())}function wy(e){for(;!br(gt());)Ve();return so(e,Ae)}function Sy(e){return Wd(Jo("",null,null,null,[""],e=Bd(e),0,[0],e))}function Jo(e,t,n,r,o,i,l,a,s){for(var c=0,m=0,p=l,h=0,g=0,v=0,y=1,N=1,f=1,u=0,d="",w=o,x=i,E=r,S=d;N;)switch(v=u,u=Ve()){case 40:if(v!=108&&me(S,p-1)==58){ts(S+=D(Go(u),"&","&\f"),"&\f")!=-1&&(f=-1);break}case 34:case 39:case 91:S+=Go(u);break;case 9:case 10:case 13:case 32:S+=yy(v);break;case 92:S+=gy(Ko()-1,7);continue;case 47:switch(gt()){case 42:case 47:Oo(xy(vy(Ve(),Ko()),t,n),s);break;default:S+="/"}break;case 123*y:a[c++]=dt(S)*f;case 125*y:case 59:case 0:switch(u){case 0:case 125:N=0;case 59+m:f==-1&&(S=D(S,/\f/g,"")),g>0&&dt(S)-p&&Oo(g>32?Uc(S+";",r,n,p-1):Uc(D(S," ","")+";",r,n,p-2),s);break;case 59:S+=";";default:if(Oo(E=Hc(S,t,n,c,m,o,a,d,w=[],x=[],p),i),u===123)if(m===0)Jo(S,t,E,E,w,i,p,a,x);else switch(h===99&&me(S,3)===110?100:h){case 100:case 108:case 109:case 115:Jo(e,E,E,r&&Oo(Hc(e,E,E,0,0,o,a,d,o,w=[],p),x),o,x,p,a,r?w:x);break;default:Jo(S,E,E,E,[""],x,0,a,x)}}c=m=g=0,y=f=1,d=S="",p=l;break;case 58:p=1+dt(S),g=v;default:if(y<1){if(u==123)--y;else if(u==125&&y++==0&&hy()==125)continue}switch(S+=Xi(u),u*y){case 38:f=m>0?1:(S+="\f",-1);break;case 44:a[c++]=(dt(S)-1)*f,f=1;break;case 64:gt()===45&&(S+=Go(Ve())),h=gt(),m=p=dt(d=S+=wy(Ko())),u++;break;case 45:v===45&&dt(S)==2&&(y=0)}}return i}function Hc(e,t,n,r,o,i,l,a,s,c,m){for(var p=o-1,h=o===0?i:[""],g=su(h),v=0,y=0,N=0;v<r;++v)for(var f=0,u=qr(e,p+1,p=uy(y=l[v])),d=e;f<g;++f)(d=Hd(y>0?h[f]+" "+u:D(u,/&\f/g,h[f])))&&(s[N++]=d);return Gi(e,t,n,o===0?lu:a,s,c,m)}function xy(e,t,n){return Gi(e,t,n,Dd,Xi(my()),qr(e,2,-2),0)}function Uc(e,t,n,r){return Gi(e,t,n,au,qr(e,0,r),qr(e,r+1,-1),r)}function Wn(e,t){for(var n="",r=su(e),o=0;o<r;o++)n+=t(e[o],o,e,t)||"";return n}function ky(e,t,n,r){switch(e.type){case sy:if(e.children.length)break;case ay:case au:return e.return=e.return||e.value;case Dd:return"";case Vd:return e.return=e.value+"{"+Wn(e.children,r)+"}";case lu:e.value=e.props.join(",")}return dt(n=Wn(e.children,r))?e.return=e.value+"{"+n+"}":""}function Ey(e){var t=su(e);return function(n,r,o,i){for(var l="",a=0;a<t;a++)l+=e[a](n,r,o,i)||"";return l}}function Cy(e){return function(t){t.root||(t=t.return)&&e(t)}}var $y=function(t,n,r){for(var o=0,i=0;o=i,i=gt(),o===38&&i===12&&(n[r]=1),!br(i);)Ve();return so(t,Ae)},_y=function(t,n){var r=-1,o=44;do switch(br(o)){case 0:o===38&&gt()===12&&(n[r]=1),t[r]+=$y(Ae-1,n,r);break;case 2:t[r]+=Go(o);break;case 4:if(o===44){t[++r]=gt()===58?"&\f":"",n[r]=t[r].length;break}default:t[r]+=Xi(o)}while(o=Ve());return t},Py=function(t,n){return Wd(_y(Bd(t),n))},Bc=new WeakMap,Ny=function(t){if(!(t.type!=="rule"||!t.parent||t.length<1)){for(var n=t.value,r=t.parent,o=t.column===r.column&&t.line===r.line;r.type!=="rule";)if(r=r.parent,!r)return;if(!(t.props.length===1&&n.charCodeAt(0)!==58&&!Bc.get(r))&&!o){Bc.set(t,!0);for(var i=[],l=Py(n,i),a=r.props,s=0,c=0;s<l.length;s++)for(var m=0;m<a.length;m++,c++)t.props[c]=i[s]?l[s].replace(/&\f/g,a[m]):a[m]+" "+l[s]}}},zy=function(t){if(t.type==="decl"){var n=t.value;n.charCodeAt(0)===108&&n.charCodeAt(2)===98&&(t.return="",t.value="")}};function Yd(e,t){switch(fy(e,t)){case 5103:return F+"print-"+e+e;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return F+e+e;case 5349:case 4246:case 4810:case 6968:case 2756:return F+e+$i+e+we+e+e;case 6828:case 4268:return F+e+we+e+e;case 6165:return F+e+we+"flex-"+e+e;case 5187:return F+e+D(e,/(\w+).+(:[^]+)/,F+"box-$1$2"+we+"flex-$1$2")+e;case 5443:return F+e+we+"flex-item-"+D(e,/flex-|-self/,"")+e;case 4675:return F+e+we+"flex-line-pack"+D(e,/align-content|flex-|-self/,"")+e;case 5548:return F+e+we+D(e,"shrink","negative")+e;case 5292:return F+e+we+D(e,"basis","preferred-size")+e;case 6060:return F+"box-"+D(e,"-grow","")+F+e+we+D(e,"grow","positive")+e;case 4554:return F+D(e,/([^-])(transform)/g,"$1"+F+"$2")+e;case 6187:return D(D(D(e,/(zoom-|grab)/,F+"$1"),/(image-set)/,F+"$1"),e,"")+e;case 5495:case 3959:return D(e,/(image-set\([^]*)/,F+"$1$`$1");case 4968:return D(D(e,/(.+:)(flex-)?(.*)/,F+"box-pack:$3"+we+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+F+e+e;case 4095:case 3583:case 4068:case 2532:return D(e,/(.+)-inline(.+)/,F+"$1$2")+e;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(dt(e)-1-t>6)switch(me(e,t+1)){case 109:if(me(e,t+4)!==45)break;case 102:return D(e,/(.+:)(.+)-([^]+)/,"$1"+F+"$2-$3$1"+$i+(me(e,t+3)==108?"$3":"$2-$3"))+e;case 115:return~ts(e,"stretch")?Yd(D(e,"stretch","fill-available"),t)+e:e}break;case 4949:if(me(e,t+1)!==115)break;case 6444:switch(me(e,dt(e)-3-(~ts(e,"!important")&&10))){case 107:return D(e,":",":"+F)+e;case 101:return D(e,/(.+:)([^;!]+)(;|!.+)?/,"$1"+F+(me(e,14)===45?"inline-":"")+"box$3$1"+F+"$2$3$1"+we+"$2box$3")+e}break;case 5936:switch(me(e,t+11)){case 114:return F+e+we+D(e,/[svh]\w+-[tblr]{2}/,"tb")+e;case 108:return F+e+we+D(e,/[svh]\w+-[tblr]{2}/,"tb-rl")+e;case 45:return F+e+we+D(e,/[svh]\w+-[tblr]{2}/,"lr")+e}return F+e+we+e+e}return e}var Oy=function(t,n,r,o){if(t.length>-1&&!t.return)switch(t.type){case au:t.return=Yd(t.value,t.length);break;case Vd:return Wn([gr(t,{value:D(t.value,"@","@"+F)})],o);case lu:if(t.length)return py(t.props,function(i){switch(dy(i,/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":return Wn([gr(t,{props:[D(i,/:(read-\w+)/,":"+$i+"$1")]})],o);case"::placeholder":return Wn([gr(t,{props:[D(i,/:(plac\w+)/,":"+F+"input-$1")]}),gr(t,{props:[D(i,/:(plac\w+)/,":"+$i+"$1")]}),gr(t,{props:[D(i,/:(plac\w+)/,we+"input-$1")]})],o)}return""})}},Ty=[Oy],Ry=function(t){var n=t.key;if(n==="css"){var r=document.querySelectorAll("style[data-emotion]:not([data-s])");Array.prototype.forEach.call(r,function(y){var N=y.getAttribute("data-emotion");N.indexOf(" ")!==-1&&(document.head.appendChild(y),y.setAttribute("data-s",""))})}var o=t.stylisPlugins||Ty,i={},l,a=[];l=t.container||document.head,Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="'+n+' "]'),function(y){for(var N=y.getAttribute("data-emotion").split(" "),f=1;f<N.length;f++)i[N[f]]=!0;a.push(y)});var s,c=[Ny,zy];{var m,p=[ky,Cy(function(y){m.insert(y)})],h=Ey(c.concat(o,p)),g=function(N){return Wn(Sy(N),h)};s=function(N,f,u,d){m=u,g(N?N+"{"+f.styles+"}":f.styles),d&&(v.inserted[f.name]=!0)}}var v={key:n,sheet:new ly({key:n,container:l,nonce:t.nonce,speedy:t.speedy,prepend:t.prepend,insertionPoint:t.insertionPoint}),nonce:t.nonce,inserted:i,registered:{},insert:s};return v.sheet.hydrate(a),v},Qd={exports:{}},U={};/** @license React v16.13.1
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hu=Symbol.for("react.element"),yu=Symbol.for("react.portal"),al=Symbol.for("react.fragment"),sl=Symbol.for("react.strict_mode"),ul=Symbol.for("react.profiler"),cl=Symbol.for("react.provider"),fl=Symbol.for("react.context"),ug=Symbol.for("react.server_context"),dl=Symbol.for("react.forward_ref"),pl=Symbol.for("react.suspense"),ml=Symbol.for("react.suspense_list"),hl=Symbol.for("react.memo"),yl=Symbol.for("react.lazy"),cg=Symbol.for("react.offscreen"),ap;ap=Symbol.for("react.module.reference");function et(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case hu:switch(e=e.type,e){case al:case ul:case sl:case pl:case ml:return e;default:switch(e=e&&e.$$typeof,e){case ug:case fl:case dl:case yl:case hl:case cl:return e;default:return t}}case yu:return t}}}B.ContextConsumer=fl;B.ContextProvider=cl;B.Element=hu;B.ForwardRef=dl;B.Fragment=al;B.Lazy=yl;B.Memo=hl;B.Portal=yu;B.Profiler=ul;B.StrictMode=sl;B.Suspense=pl;B.SuspenseList=ml;B.isAsyncMode=function(){return!1};B.isConcurrentMode=function(){return!1};B.isContextConsumer=function(e){return et(e)===fl};B.isContextProvider=function(e){return et(e)===cl};B.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===hu};B.isForwardRef=function(e){return et(e)===dl};B.isFragment=function(e){return et(e)===al};B.isLazy=function(e){return et(e)===yl};B.isMemo=function(e){return et(e)===hl};B.isPortal=function(e){return et(e)===yu};B.isProfiler=function(e){return et(e)===ul};B.isStrictMode=function(e){return et(e)===sl};B.isSuspense=function(e){return et(e)===pl};B.isSuspenseList=function(e){return et(e)===ml};B.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===al||e===ul||e===sl||e===pl||e===ml||e===cg||typeof e=="object"&&e!==null&&(e.$$typeof===yl||e.$$typeof===hl||e.$$typeof===cl||e.$$typeof===fl||e.$$typeof===dl||e.$$typeof===ap||e.getModuleId!==void 0)};B.typeOf=et;lp.exports=B;var fg=lp.exports;C`
  from,
  20%,
  53%,
  to {
...
`;function Cg({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=gu,iterationCount:o=1}){return rp`
...
`;function Ug(e,t,n){switch(n){case"bottom-left":return t?Og:pg;case"bottom-right":return t?Tg:mg;case"down":return e?t?Ag:yg:t?Rg:hg;case"left":return e?t?Mg:gg:t?Ig:gu;case"right":return e?t?jg:wg:t?Lg:vg;case"top-left":return t?Fg:Sg;case"top-right":return t?Dg:xg;case"up":return e?t?Hg:Eg:t?Vg:kg;default:return t?zg:dg}}const Bg=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=I.useMemo(()=>Ug(t,r,n),[t,n,r]);return se(up,{keyframes:i,...o})};C`
  from {
...
`;function pv(){const[e,t]=I.useState(!1),[n,r]=I.useState(!1),[o,i]=I.useState(!1);function l(){t(!0),r(!1),i(!1)}function a(){t(!1),r(!0),i(!1)}function s(){t(!1),r(!1),i(!0)}return _.jsxs(sv,{children:[_.jsxs(uv,{children:[_.jsx("h1",{children:"Rafael Ribeiro"}),_.jsx("h2",{children:"Desenvolvedor Frontend e Engenheiro de Software"}),_.jsx("p",{children:"Crio sites responsivos, soluções web e alguns jogos 🎮"}),_.jsxs(cv,{children:[_.jsx("button",{onClick:l,children:"Sobre"}),_.jsx("button",{onClick:a,children:"Experiência"}),_.jsx("button",{onClick:s,children:"Projetos"})]}),_.jsxs(fv,{children:[_.jsx("a",{href:"https://www.linkedin.com/in/rafaelribeirodev/",target:"_blank",children:_.jsx(mp,{size:24})}),_.jsx("a",{href:"https://github.com/RafahOlive",target:"_blank",children:_.jsx(pp,{size:24})})]})]}),_.jsx(dv,{children:_.jsxs(Bg,{duration:1e3,children:[e&&_.jsx(Wh,{}),n&&_.jsx(Xh,{}),o&&_.jsx(ry,{})]})})]})}const mv=Bh`
*{
  margin: 0;
  padding: 0;
...
`;function hv(){return _.jsxs(_.Fragment,{children:[_.jsx(mv,{}),_.jsx(pv,{})]})}bl.createRoot(document.getElementById("root")).render(_.jsx(O.StrictMode,{children:_.jsx(hv,{})}));
