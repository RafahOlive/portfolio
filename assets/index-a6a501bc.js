...
`;function Qh(){return k.jsx(k.Fragment,{children:k.jsxs(Hh,{children:[k.jsx(Wh,{children:"2022 - 2023"}),k.jsxs(Yh,{children:[k.jsx("h3",{children:"Pacto Soluções"}),k.jsx("h4",{children:"Desenvolvedor frontend"}),k.jsx("p",{children:"Criação de páginas web utilizando componentes criados pela Pacto, usando Angular (Versão 8 /Node 12.22.12). Essas páginas tem interligação com o Backend onde eu criava formulários e exibo em listas. Realizava a criação de novos componentes ou alteração dos mesmos de acordo com as especificações. Realizava as documentações dos componentes utilizando Storybook. Projeto iniciado por mim e orquestrado através do PM e tech lead, onde a estratégia eram documentar os componentes sem atrapalhar as sprints e criar um design system. Adquiri conhecimentos em docker no decorrer do projeto para ter acesso aos serviços de backend local, para assim ganhar velocidade nas entregas. Participei de reuniões para arquitetar um novo design system da Pacto, junto com a reformulação dos componentes e alinhamento com o time de UX. Usava o Gitlab como versionador e acompanhava as publicações através da pipeline. Utilizava o Jira para controle da sprint e apontamentos de horas."})]})]})})}const Jl="/portfolio/assets/todo-fd76723f.png",Xh=ve.div`
  width: auto;
  height: 28px;
...
`;function Ig(e,t,n){switch(n){case"bottom-left":return t?kg:ig;case"bottom-right":return t?Eg:lg;case"down":return e?t?$g:sg:t?Cg:ag;case"left":return e?t?Pg:ug:t?_g:Eu;case"right":return e?t?zg:fg:t?Ng:cg;case"top-left":return t?Tg:dg;case"top-right":return t?Rg:pg;case"up":return e?t?Og:hg:t?jg:mg;default:return t?xg:og}}const Lg=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=L.useMemo(()=>Ig(t,r,n),[t,n,r]);return ae(s0,{keyframes:i,...o})};$`
  from {
